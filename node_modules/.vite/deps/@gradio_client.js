...
async function qt(e, t, s) {
  ...
  try {
    ...
    if (typeof process < "u" && process.versions && process.versions.node) {
      const g = await import("./__vite-browser-external-DYxpcVy9-WURJQMUS.js");
      l = (await import("./__vite-browser-external-DYxpcVy9-WURJQMUS.js")).resolve(process.cwd(), n.meta.path), a = await g.readFile(l);
    } else
      throw new Error(yt);
